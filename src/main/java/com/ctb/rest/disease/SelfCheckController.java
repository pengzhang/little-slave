...
//	private static Logger logger = LoggerFactory.getLogger(RestController.class);
	...
	@ApiOperation(value = "通过身体具体部分获取疾病列表", notes = "通过身体具体部分获取疾病列表", response = JsonNode.class)
	...
	@Produces(MediaType.APPLICATION_JSON)
	@ApiOperation(value = "通过身体大部分获取疾病列表", notes = "通过身体大部分获取疾病列表", response = JsonNode.class)
	@ApiResponses(value = { @ApiResponse(code = 400, message = "创建失败"), @ApiResponse(code = 404, message = "地址无效") })
	...
	@Produces(MediaType.APPLICATION_JSON)
	@ApiOperation(value = "分页获取部位疾病信息", notes = "分页获取部位疾病信息", response = JsonNode.class)
	@ApiResponses(value = { @ApiResponse(code = 400, message = "创建失败"), @ApiResponse(code = 404, message = "地址无效") })
	...
	@Path("/disease/{code}")
	@Produces(MediaType.APPLICATION_JSON)
	@ApiOperation(value = "通过Code获取疾病信息", notes = "通过Code获取疾病信息", response = JsonNode.class)
	@ApiResponses(value = { @ApiResponse(code = 400, message = "创建失败"), @ApiResponse(code = 404, message = "地址无效") })
	...
	@Produces(MediaType.APPLICATION_JSON)
	@ApiOperation(value = "通过Code获取疾病详细信息", notes = "通过Code获取疾病详细信息", response = JsonNode.class)
	@ApiResponses(value = { @ApiResponse(code = 400, message = "创建失败"), @ApiResponse(code = 404, message = "地址无效") })
